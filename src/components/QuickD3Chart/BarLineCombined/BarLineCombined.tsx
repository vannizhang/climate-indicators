...
} from '../elements/PointerEventsOverlay';
...
type XScale = ScaleBand<string | number> | ScaleTime<number, number> | ScaleLinear<number, number>;
...
const BarLineCombined:React.FC<Props> = ({
    ...
    const [ pointerPositionOnHover, setPointerPositionOnHover ] = useState<PointerPositionOnHover>();
    ...
    const xDomain = useMemo(()=>{
        ...
        const data = data4Bars && data4Bars.length 
            ? [...data4Bars]
            : [...data4Line];
    ...
    const yScale = useMemo(():YScale=>{
        ...
        const ymax4Bars = data4Bars && data4Bars.length
            ? max(data4Bars, d=>d.value)
            : 0;
        ...
        const ymax4Lines = data4Line && data4Line.length 
