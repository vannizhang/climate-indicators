...
import { select, line, ScaleBand, ScaleLinear, ScaleTime, curveMonotoneX } from 'd3';
...
type Props = {
    xScale: ScaleBand<String | number> | ScaleTime<number, number> | ScaleLinear<number, number>;
